...
def fit_base_param_decay(x: np.ndarray, y: np.ndarray, param_guesses: tuple = (1., .9, 0.),
...
def fit_decay_constant_param_decay(x: np.ndarray, y: np.ndarray, param_guesses: tuple = (1., 10, 0),
                                   weights: np.ndarray = None) -> ModelResult:
    """
...
def fit_decaying_sinusoid(x: np.ndarray, y: np.ndarray, param_guesses: tuple = (.5, 10, 0.5, 0., 5),
                          weights: np.ndarray = None) -> ModelResult:
    """
...
def fit_shifted_cosine(x: np.ndarray, y: np.ndarray, param_guesses: tuple = (.5, 0, .5, 1.),
                       weights: np.ndarray = None) -> ModelResult:
    """
