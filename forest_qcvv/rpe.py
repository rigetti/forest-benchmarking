...
def acquire_rpe_data(experiments: DataFrame, quantum_machine: QuantumComputer, multiplicative_factor: float = 1.0,
    ...
    :param quantum_machine: a quantum machine, e.g. QVM or QPU, that runs the experiments
    ...
    def run(qc: QuantumComputer, exp: Program, num_trials: int) -> np.ndarray:
        exp.wrap_in_numshots_loop(num_trials)
    ...
    results = [run(quantum_machine, experiment,
